...
using Alex.MoLang.Runtime.Struct.Interop;
...
namespace Alex.MoLang.Runtime.Struct
{
	...
	///
	///		Any fields or properties that you want to allow access to requires the <see cref="Alex.MoLang.Attributes.MoPropertyAttribute"/> to be applied.
	///
	///		Any functions that should be accessible by MoLang require the <see cref="Alex.MoLang.Attributes.MoFunctionAttribute"/> to be applied
	/// </remarks>
